...
On the other hand, Amazon's diversification into groceries and pharmacies is part of their bid to be the one stop shop for e-commerce by building an ecosystem of retailers all powered by Amazon technology. Even their failed attempt to enter the smartphone market with the much-maligned Fire Phone was meant to make it easy for users to purchase prodcuts from Amazon - a key feature of the Fire Phone its ability to recognize objects from photos and present the user with an Amazon page listing the item from the photo.
...
Indeed, if one follows the machine learning community, one can see that the tech industry is far from stagnating as breakthroughs are made on a nearly daily basis. In this year alone: Google created an AI that taught itself to beat the top ranked Go player by playing against itself thousands of times, Stanford researchers have developed an AI that can make more accurate diagnoses from X-rays than practicing radiologists, and Google's AutoML project succeeded in creating an AI that can create other AIs. (For a deeper discussion on how to implement machine learning for your business, feel free to reach out to me on LinkedIn.) There is a reason why Elon Musk thinks that AI is such a big threat to humanity - it is just that powerful.
